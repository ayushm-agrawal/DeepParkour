...
class PPO_AGENT:
    def __init__(self, env, batch_size=64, optim_epochs=10, optim_stepsize=1e-4, total_timesteps=1e6, gamma=0.99, lam=0.95, tsteps_per_act=2048, ent_coeff=0.0, clip_param=0.1):
        self.env = env
    ...
    def policy(self):
        pi = pposgd_simple.learn(self.env , self.policy_fn,
